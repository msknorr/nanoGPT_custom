...
wandb_run_name = 'nochmal_rope_biggerlr_lucid' # 'run' + str(time.time())
# data
dataset = 'enwik8_char'
...
pos_enc = "rope"  # one of None, 'learnt', 'rope'
intermediate_layer_loss = False  # https://arxiv.org/pdf/1808.04444.pdf
# -----------------------------------------------------------------------------
